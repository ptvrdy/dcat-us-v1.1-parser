...
extension_metadata = {
    "cpg": {"format": "CPG", "mediaType": "application/octet-stream", "defaultDescription": "GIS project component file."},
    "csv": {"format": "CSV", "mediaType": "text/csv", "defaultDescription": "CSV dataset file."},
    "dbf": {"format": "DBF", "mediaType": "application/dbf", "defaultDescription": "GIS project component file."},
    "docx": {"format": "DOCX", "mediaType": "application/msword", "defaultDescription": "Microsoft Word documentation file for the dataset."},
    "json": {"format": "JSON", "mediaType": "application/json", "defaultDescription": "This file contains metadata about the project."},
    "md": {"format": "MD", "mediaType": "text/markdown", "defaultDescription": "Markdown documentation file for the dataset."},
    "pdf": {"format": "PDF", "mediaType": "application/pdf", "defaultDescription": "PDF files for dataset."},
    "pptx": {"format": "PPTX", "mediaType": "application/vnd.ms-powerpoint", "defaultDescription": "PowerPoint file for the project."},
    "prj": {"format": "PRJ", "mediaType": "application/octet-stream", "defaultDescription": "This file contains projection information for GIS datasets."},
    "rtf": {"format": "RTF", "mediaType": "text/rtf", "defaultDescription": "This file contains contains information about the dataset."},
    "sbn": {"format": "SBN", "mediaType": "application/octet-stream", "defaultDescription": "This file is associated with spatial index files for Esri shapefiles."},
    "sbx": {"format": "SBX", "mediaType": "application/octet-stream", "defaultDescription": "This file is associated with spatial index files for Esri shapefiles."},
    "shp": {"format": "SHP", "mediaType": "application/x-esri-shapefile", "defaultDescription": "This file represents the actual geometries of a shapefile dataset."},
    "txt": {"format": "TXT", "mediaType": "text/plain", "defaultDescription": "Plain text file."},
    "xlsx": {"format": "XLSX", "mediaType": "application/vnd.ms-excel", "defaultDescription": "XLSX dataset files for the project."}
}